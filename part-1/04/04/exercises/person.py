...
def get_most_common_month(people):
    """
    iterate each person in the people list
    get the birthday month of each person
    increase the count of the month in the months dictionary
    get the month with the largest count

    :param people: A list of dictionaries representing people's data. Each dictionary should have a 'birthday' key
    containing the birthday in the format 'month/day/year'.
    :return: The month with the largest number of birthdays in the 'people' data.
    """
    # TODO:
